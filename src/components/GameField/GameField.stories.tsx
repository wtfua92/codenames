...
const transformWordsToCardsData = (words: Word[], picked: boolean) =>
  words.map((w, i) => <WordCard index={i + 1} key={w.id} isPicked={picked} {...w} onClick={action("click")} />);
...
export const GameFieldWithUnpickedWords = (): ReactNode => <GameField wordCards={unpickedWordData} />;

export const GameFieldWithPickedWords = (): ReactNode => <GameField wordCards={pickedWordData} />;
